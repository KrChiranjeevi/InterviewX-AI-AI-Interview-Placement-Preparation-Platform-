        ...
        <main className="flex-1 overflow-y-auto p-8 no-scrollbar">
          ...
          >
            ...
            <div className="relative z-10 flex flex-col md:flex-row justify-between items-center">
              <div>
                <h2 className="text-3xl font-bold text-white mb-3">Ready to crack your next interview? ≡ƒÜÇ</h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-8">
            ...
            >
              <div className="absolute top-0 right-0 p-4 opacity-10 text-6xl">≡ƒñû</div>
              <h3 className="text-xl font-bold text-white mb-6">AI Recommendations</h3>
              
              <div className="space-y-4 relative z-10">
                <div className="p-4 bg-red-500/10 border border-red-500/20 rounded-xl">
                  <p className="text-red-200 font-medium">ΓÜá∩╕Å Area of Improvement</p>
                ...
                <div className="p-4 bg-green-500/10 border border-green-500/20 rounded-xl">
                  <p className="text-green-200 font-medium">≡ƒîƒ Strengths</p>
                      ...
                      <div className="text-xs text-slate-400">
                        {sim.completed ? (
                          <span className="text-emerald-450 font-bold flex items-center gap-1">
                            Decision: {sim.hiringDecision} ≡ƒÄë
                          </span>
                        ) : (
